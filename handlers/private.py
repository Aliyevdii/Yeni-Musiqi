...
Ben {bot}! Sesli sohbetlerde müzik çalabilen botum. Ban yetkisiz, Ses yönetimi yetkisi verip, Asistanı gruba ekleyiniz. Komutlar için /help komutunu kullanın.**""",

        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "🏷️ Beni gruba ekle", url="https://t.me/HerTeldenMuzikBot?startgroup=a"
                    ),
                    InlineKeyboardButton(
...
@Client.on_message(filters.command(["reload", f"reload@{BOT_USERNAME}"]) & ~filters.private & ~filters.channel)
...
@Client.on_message(filters.command(["help", f"help@{BOT_USERNAME}"]))
